...
namespace asp_servicios
{
    public class Startup
    {
        ...
        public void ConfigureServices(WebApplicationBuilder builder, IServiceCollection services)
        {
            ...
            services.AddScoped<IZapatosAplicacion, ZapatosAplicacion>();
            services.AddScoped<ICuentaClientesAplicacion, CuentaClientesAplicacion>();
            services.AddScoped<ICuentaEmpleadosAplicacion, CuentaEmpleadosAplicacion>();
